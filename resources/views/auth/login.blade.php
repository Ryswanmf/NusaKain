...
<body class="bg-gray-50/50 min-h-screen flex items-center justify-center p-6">
    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-[3rem] p-10 md:p-12 border border-gray-100 shadow-sm">
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Selamat <span class="text-blue-600">Datang!</span></h1>
            ...
            @if (Route::has('register'))
                <p class="mt-10 text-center text-sm text-slate-500 font-medium">
                    Belum punya akun? 
                    <a href="{{ route('register') }}" class="text-blue-600 font-bold hover:underline underline-offset-4 decoration-2">Daftar Gratis</a>
                </p>
            @endif
        </div>
