    ...
    <x-slot name="header">
        <div class="flex items-center space-x-5">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 font-medium mt-1">Perkenalkan wajah-wajah hebat di balik layar.</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="bg-white p-10 md:p-12 rounded-[3rem] border border-slate-100 shadow-sm space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-3">
                                ...
                                <input type="text" name="position" id="position" value="{{ old('position') }}" required
                                    class="w-full px-8 py-5 bg-slate-50 border-none rounded-[2rem] focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all font-bold text-slate-900 placeholder-slate-300" placeholder="Contoh: CEO, Designer">
                        ...
                        <div class="space-y-3">
                            ...
                            <textarea name="bio" id="bio" rows="6"
                                class="w-full px-8 py-6 bg-slate-50 border-none rounded-[2rem] focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all font-medium text-slate-600 leading-relaxed placeholder-slate-300" placeholder="Ceritakan latar belakang atau peran pentingnya...">{{ old('bio') }}</textarea>
                    ...
                    <div class="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm space-y-6">
                        ...
                        <div class="relative group aspect-square bg-slate-50 rounded-[3rem] border-2 border-dashed border-slate-200 flex flex-col items-center justify-center overflow-hidden transition-all hover:border-teal-400 hover:bg-teal-50/30">
                            ...
                            <div id="upload-placeholder" class="text-center p-6">
                                ...
                                <p class="text-xs font-black text-slate-400 uppercase tracking-widest">Unggah Foto</p>
                            </div>
                        </div>
