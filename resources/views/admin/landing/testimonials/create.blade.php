    ...
    <x-slot name="header">
        <div class="flex items-center space-x-5">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 font-medium mt-1">Berikan suara kepada partner setia Nusakain.</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="bg-white p-10 md:p-12 rounded-[3rem] border border-slate-100 shadow-sm space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-3">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" required
                                    class="w-full px-8 py-5 bg-slate-50 border-none rounded-[2rem] focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all font-bold text-slate-900 placeholder-slate-300" placeholder="Nama lengkap">
                            </div>
                            <div class="space-y-3">
                                <label class="text-xs font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Jabatan / Brand</label>
                                <input type="text" name="position" value="{{ old('position') }}"
                                    class="w-full px-8 py-5 bg-slate-50 border-none rounded-[2rem] focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all font-bold text-slate-900 placeholder-slate-300" placeholder="Contoh: Owner Bloom Fashion">
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <textarea name="content" rows="6" required
                                class="w-full px-8 py-6 bg-slate-50 border-none rounded-[2rem] focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all font-medium text-slate-600 leading-relaxed placeholder-slate-300" placeholder="Tuliskan kata-kata apresiasi partner..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-10">
                    <div class="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm space-y-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <input type="text" name="avatar_text" value="{{ old('avatar_text') }}" maxlength="2"
                        ...
                        <div class="space-y-3">
                            ...
                            <select name="avatar_color" class="w-full px-8 py-5 bg-slate-50 border-none rounded-[2rem] focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all font-bold text-slate-900">
                                <option value="teal">Teal (Nusakain Blue)</option>
