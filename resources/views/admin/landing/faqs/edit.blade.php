    ...
    <x-slot name="header">
        <div class="flex items-center space-x-3 md:space-x-5 w-full">
            ...
            <div class="min-w-0">
                ...
                <p class="hidden xs:block text-[11px] md:text-sm text-slate-500 font-medium mt-0.5">Perbarui informasi jawaban pelanggan.</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="bg-white p-6 md:p-12 rounded-[2rem] md:rounded-[3rem] border border-slate-100 shadow-sm space-y-6 md:space-y-8">
                        ...
                        <div class="space-y-2 md:space-y-3">
                            ...
                            <textarea name="answer" id="answer" rows="6" required
                                class="w-full px-5 py-4 md:px-8 md:py-6 bg-slate-50 border-none rounded-xl md:rounded-[2rem] focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all font-medium text-slate-600 text-sm md:text-base leading-relaxed">{{ old('answer', $faq->answer) }}</textarea>
                        </div>
                    </div>
                </div>
