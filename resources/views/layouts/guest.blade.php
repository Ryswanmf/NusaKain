...
<head>
    ...
    <meta property="og:image" content="@yield('meta_image', asset('assets/landing/hero-landingpage.png'))">
                ...
                @auth
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-2xl shadow-xl border border-slate-50 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-[60]">
                            ...
                            @endif
                            <a href="{{ route('customer.dashboard') }}" class="block px-5 py-2.5 text-sm font-bold text-slate-700 hover:text-teal-600 hover:bg-teal-50 transition-colors">Dashboard Akun</a>
