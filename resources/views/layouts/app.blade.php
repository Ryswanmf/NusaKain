        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-72 bg-slate-900 text-white transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out shadow-2xl lg:shadow-none">
            <div class="flex flex-col h-full">
                ...
                <nav id="sidebar-nav" class="flex-1 px-6 space-y-2 overflow-y-auto pb-8">
                    ...
                    <a href="{{ route('admin.vouchers.index') }}" class="flex items-center space-x-3 px-4 py-3.5 rounded-2xl {{ Request::routeIs('admin.vouchers.*') ? 'bg-teal-500 text-slate-900 shadow-lg shadow-teal-500/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }} transition-all font-bold text-sm">
                    ...
                    <p class="px-4 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mt-8 mb-4">Bantuan</p>
